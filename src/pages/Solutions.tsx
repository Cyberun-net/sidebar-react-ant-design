    ...
    sections: [
      {
        ...
        questions: [
          {
            question: 'Does the supplier have a Product Security Policy for this solution ?',
            answer: ''
          },
          {
            question: 'If yes, can the supplier provide it ?',
            answer: ''
          },
          {
            question: 'If yes, does this policy include a Product Security Risks Assessment (and risks treatment) ?',
            answer: ''
          },
          {
            question: 'If yes, does this policy include a Product Security vulnerabilities management process ?',
            answer: ''
          }
        ]
      }
    ...
    sections: [
      {
        ...
        questions: [
          {
            question: 'The supplier/provider can prove it does not unnecessarily capture customer\'s data',
            answer: ''
          },
          {
            question: 'if yes, Please precise how you are willing to document this',
            answer: 'offline and on-premise solution without any connection to vendor\'s systems, customers for support service collect email and phone during their contract, all are documented regarding GDPR'
          },
          {
            question: 'If data collection is needed, is it transparent to customers ?',
            answer: ''
          }
        ]
      }
