          ...
          schema: {
            ...
            properties: {
              ...
              a11: {
                ...
                title: "Company Size",
                readOnly: true,
                enum: ["Small", "Medium", "Large"], // Limite les valeurs possibles
              },
              ...
              a10: {
                ...
                items: {
                  type: "string",
                  enum: ["Security", "Cloud", "Compliance", "Data"], // Keywords prédéfinis
                  readOnly: true,
                },
              },
            },
    ...
    schema: {
      ...
      properties: {
        ...
        d03: {
          ...
          readOnly: true,
          enum: ["Confidential", "Restricted", "Public"],
        },
        d05: {
          type: "array",
          ...
          items: {
            type: "string",
            enum: ["France", "USA", "Germany", "India", "Japan"],
            readOnly: true,
          },
        },
        d06: {
        ...
        e05: {
          ...
          readOnly: true,
          enum: ["Role-Based", "Permission-Based", "Hybrid"],
        },
        e07: {
          type: "string",
        ...
        m02: {
          ...
          readOnly: true,
          enum: ["Password", "Biometric", "Two-Factor Authentication"],
        },
        m03: {
          type: "string",
          title: "Data Governance",
          readOnly: true,
          enum: ["ISO 27001", "COBIT", "ITIL"],
        },
        ...
        k01: {
          ...
          readOnly: true,
          enum: ["Email", "Phone Number", "Address", "Payment Details"],
        },
        k02: {
          type: "string",
        ...
        k04: {
          ...
          readOnly: true,
          enum: ["Full Access", "Restricted Access", "No Access"],
        },
        k05: {
          type: "string",
        ...
        z01: {
          ...
          readOnly: true,
          enum: ["Ethical", "Non-Ethical", "Under Review"],
        },
      },
    },
    uiSchema: {
          ...
          schema: {
              ...
              properties: {
                  ...
                  p08: {
                      ...
                      items: {
                          type: "string",
                          enum: ["France", "USA", "Germany", "Japan", "India"], 
                          readOnly: true,
                      },
                  },
                  // Certification
                  c01: {
                      ...
                      items: {
                          type: "string",
                          enum: ["ISO 27001", "SOC 2", "PCI DSS", "GDPR Compliance"], 
                          readOnly: true,
                      },
                  },
                  c03: {
                      ...
                      items: {
                          type: "string",
                          enum: ["ISO 9001", "CMMC Level 2", "NIST Compliance"],
                          readOnly: true,
                      },
                  },
                  // HR
                  ...
                  h02: {
                      ...
                      title: "HR Policies",
                      readOnly: true,
                      enum: ["Flexible", "Strict", "Standardized"], 
                  },
                  // Dependence Risk
                  r01: {
                      type: "array",
                  ...
                  r05: {
                      ...
                      readOnly: true,
                      enum: ["Monthly", "Quarterly", "Yearly", "On Request"],
                  },
                  r07: {
                      type: "string",
                      title: "Disaster Recovery Plans",
                      readOnly: true,
                      enum: ["Implemented", "Not Implemented", "In Progress"],
                  },
                  r08: {
                      type: "string",
                  ...
                  r12: {
                      ...
                      readOnly: true,
                      enum: ["Nagios", "Zabbix", "Datadog", "Splunk"],
                  },
                  r13: {
                      type: "string",
                  ...
                  q02: {
                      ...
                      readOnly: true,
                      enum: ["ISO 9001", "ISO 14001", "ISO 45001"],
                  },
                  q03: {
                      type: "string",
                      title: "Quality Certifications",
                      readOnly: true,
                      enum: ["ISO Certified", "Pending Certification", "Not Certified"],
                  },
                  q07: {
                      type: "string",
                  ...
                  t01: {
                      ...
                      readOnly: true,
                      enum: ["Publicly Available", "Internal Only", "Restricted"],
                  },
                  t02: {
                      type: "string",
      ...
      <>
        ...
        >
          <Space direction="vertical" size="large" style={{ width: "250%" }}>
            {activeTabData.section?.map((section, sectionIndex) => {
